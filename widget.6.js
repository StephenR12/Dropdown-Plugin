...
prism.registerWidget('wiserFormulaWidget', {
  name: 'wiserFormulaWidget',
  family: 'wiser',
  title: 'Filter',
  priority: 0,

  iconSmall: '/plugins/WiserFormulaWidget/images/wiser-widget-24.png',

  style: {
    ignoreDashboardFilter: true,
    multipleSelect: true
  },
  styleEditorTemplate: '/plugins/WiserFormulaWidget/style-editor/template.html',
  hideNoResults: true,

  directive: 'wiser-formula-widget',
